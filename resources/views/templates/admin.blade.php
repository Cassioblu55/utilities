    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ProjectRoute::getProjectBase()}}">Utilities</a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{ProjectRoute::makeRoute("defaultServerMessages")}}">Defualt Server Messages</a></li>
                        </ul>
                    </li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    @if (Auth::guest())
                        <li><a href="{{ ProjectRoute::makeRoute('login') }}">Login</a></li>
                        <li><a href="{{ ProjectRoute::makeRoute('register') }}">Register</a></li>
                    @else
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ ProjectRoute::makeRoute('logout') }}"><i class="fa fa-btn fa-sign-out"></i>Logout</a></li>
                            </ul>
                        </li>
                    @endif
                </ul>
